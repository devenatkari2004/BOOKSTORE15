...
function Navbar() {
  ...
  const navItems = (
    <>
      ...
      <li>
        <a  onClick={()=>document.getElementById("my_contact").showModal()}>
          Contact
        </a>  
        <Contact />
      </li>
  ...
  return (
    ...
    <div>
      ...
      <ul
        tabIndex={0}
        className="menu menu-sm dropdown-content int-3 z-[1] p-2 shadow bg-base-100 roumd-box w-52"
        >
        {navItems}
      </ul>
    </div>
    
    <a className="text-2xl fontbold cursor-pointer">Engg.Hub</a>
  </div> 
